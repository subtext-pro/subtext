...
Subtext Pro is a collection of color themes for VS Code. This repository consists of **320+ syntax and UI themes** for [Visual Studio Code](https://code.visualstudio.com/).
...
To install the color themes, just use the extensions tab within VS Code and search for 'Subtext Pro'.
