...
import Benjamindean325LandingPage from "./components/Benjamindean325LandingPage";

function App() {
  return (
    <Router>
      <Switch>
        <Route path="/:path(|benjamindean325-landing-page)">
          <Benjamindean325LandingPage {...benjamindean325LandingPageData} />
        </Route>
      </Switch>
    </Router>
  );
...
const benjamindean325LandingPageData = {
    ...
    spanText12: <React.Fragment>Subtext Pro comes with a set of color filters <br />to suit your mood. Whether you want to code like a robot or feel like controlling a spaceship, there&#x27;s a matching color filter for you.</React.Fragment>,
    ...
    spanText16: "© 2022 Subtext Pro. ALL RIGHTS RESERVED",
    spanText17: "How to install free evaluation for VS Code:",
    spanText18: <React.Fragment>1. Package Control ‣ Install Package ‣ Theme -Subtext Pro<br />2. Command Palette ‣ Monokai Pro: select theme</React.Fragment>,
    ...
    be65307B6F17Cb232: "https://anima-uploads.s3.amazonaws.com/projects/63ad04bf271484f4b798c6ce/releases/63ad04da0c5699f0e3a06976/img/be65307b6f17cb23-2-1@2x.png",
